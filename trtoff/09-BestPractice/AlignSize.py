...
b = time.time()
print("run(32, 256, 2048, True) run time = %f" % (b - a))
a = time.time()
run(31, 256, 2048, True)  # nM -> nM-1
b = time.time()
print("run(31, 256, 2048, True) run time = %f" % (b - a))
a = time.time()
run(32, 255, 2048, True)  # nK -> nK-1
b = time.time()
print("run(32, 255, 2048, True) run time = %f" % (b - a))
a = time.time()
run(32, 256, 2047, True)  # nN -> nN-1
b = time.time()
print("run(32, 256, 2047, True) run time = %f" % (b - a))

a = time.time()
run(32, 256, 2048, False)
b = time.time()
print("run(32, 256, 2048, False) run time = %f" % (b - a))
a = time.time()
run(31, 256, 2048, False)  # nM -> nM-1
b = time.time()
print("run(31, 256, 2048, False) run time = %f" % (b - a))
a = time.time()
run(32, 255, 2048, False)  # nK -> nK-1
b = time.time()
print("run(32, 255, 2048, False) run time = %f" % (b - a))
a = time.time()
run(32, 256, 2047, False)  # nN -> nN-1
b = time.time()
print("run(32, 256, 2047, False) run time = %f" % (b - a))


"""
run(32, 256, 2048, True) run time = 10.077313
run(31, 256, 2048, True) run time = 8.616961
run(32, 255, 2048, True) run time = 10.066035
run(32, 256, 2047, True) run time = 10.072284
run(32, 256, 2048, False) run time = 11.497712
run(31, 256, 2048, False) run time = 10.960200
run(32, 255, 2048, False) run time = 13.286958
run(32, 256, 2047, False) run time = 13.266007
"""