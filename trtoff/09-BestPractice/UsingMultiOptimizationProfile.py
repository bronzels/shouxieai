...
def mytest(engine, context, nBatchSize):
    ...
    for i in range(nInput):
        print("Bind[%2d]:i[%2d]->" % (i, i), engine.get_binding_dtype(i), engine.get_binding_shape(i), engine.get_binding_name(i))
    for i in range(nInput, nInput + nOutput):
        print("Bind[%2d]:o[%2d]->" % (i, i - nInput), engine.get_binding_dtype(i), engine.get_binding_shape(i), engine.get_binding_name(i))
...
def run(nProfile):
    ...
    mytest(engine, context, 1)
    mytest(engine, context, 4)
    mytest(engine, context, 510)
    mytest(engine, context, 512)
...
Bind[ 0]:i[ 0]-> DataType.FLOAT (-1, 1) tensor0
Bind[ 1]:o[ 0]-> DataType.FLOAT (-1,) tensor8
+---- BatchSize= 1: 0.5089ms

Bind[ 0]:i[ 0]-> DataType.FLOAT (-1, 1) tensor0
Bind[ 1]:o[ 0]-> DataType.FLOAT (-1,) tensor8
+---- BatchSize= 4: 0.5086ms

Bind[ 0]:i[ 0]-> DataType.FLOAT (-1, 1) tensor0
Bind[ 1]:o[ 0]-> DataType.FLOAT (-1,) tensor8
+---- BatchSize=510: 1.1705ms

Bind[ 0]:i[ 0]-> DataType.FLOAT (-1, 1) tensor0
Bind[ 1]:o[ 0]-> DataType.FLOAT (-1,) tensor8
+---- BatchSize=512: 1.1593ms

Succeeded building model-2.plan!
Bind[ 0]:i[ 0]-> DataType.FLOAT (-1, 1) tensor0
Bind[ 1]:i[ 1]-> DataType.FLOAT (-1,) tensor8
Bind[ 2]:o[ 0]-> DataType.FLOAT (-1, 1) tensor0 [profile 1]
Bind[ 3]:o[ 1]-> DataType.FLOAT (-1,) tensor8 [profile 1]
+---- BatchSize= 1: 0.2321ms

Bind[ 0]:i[ 0]-> DataType.FLOAT (-1, 1) tensor0
Bind[ 1]:i[ 1]-> DataType.FLOAT (-1,) tensor8
Bind[ 2]:o[ 0]-> DataType.FLOAT (-1, 1) tensor0 [profile 1]
Bind[ 3]:o[ 1]-> DataType.FLOAT (-1,) tensor8 [profile 1]
+---- BatchSize= 4: 0.2516ms

Bind[ 0]:i[ 0]-> DataType.FLOAT (-1, 1) tensor0
Bind[ 1]:i[ 1]-> DataType.FLOAT (-1,) tensor8
Bind[ 2]:o[ 0]-> DataType.FLOAT (-1, 1) tensor0 [profile 1]
Bind[ 3]:o[ 1]-> DataType.FLOAT (-1,) tensor8 [profile 1]
+---- BatchSize=510: 1.1709ms

Bind[ 0]:i[ 0]-> DataType.FLOAT (-1, 1) tensor0
Bind[ 1]:i[ 1]-> DataType.FLOAT (-1,) tensor8
Bind[ 2]:o[ 0]-> DataType.FLOAT (-1, 1) tensor0 [profile 1]
Bind[ 3]:o[ 1]-> DataType.FLOAT (-1,) tensor8 [profile 1]
+---- BatchSize=512: 1.1598ms
