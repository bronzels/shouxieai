...
if not os.path.exists(onnxFile):
    ...
    exit()
print("Succeed finding ONNX file!")
...
"""
2023-10-20 12:32:05.206488, epoch 10, loss = 0.010111, test acc = 0.950000
pyTorch eval time = 0.000362

TF32
tensorRT eval time = 0.000398

FP16
tensorRT eval time = 0.000366

INT8
tensorRT eval time = 0.000282

C++
TP32
tensorRT eval time: 0.00400845

FP16
tensorRT eval time: 0.00051110
...
WARNING: - 5 weights are affected by this issue: Detected subnormal FP16 values.
WARNING: - 1 weights are affected by this issue: Detected values less than smallest positive FP16 subnormal value and converted them to the FP16 minimum subnormalized value.

INT8
tensorRT eval time: 0.00046013
tensorRT eval time: 0.00045290
结果错误是1
